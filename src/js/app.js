...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          } ${variables.name == null ? "[Name]" : variables.name}</h1>
          <h2>${
            variables.role == null ? "Choose your role" : variables.role
          }</h2>
          <h3>${
            variables.city == null ? "Choose your city" : variables.city
          } , ${
    variables.country == null ? "Choose your country" : variables.country
  }</h3>
